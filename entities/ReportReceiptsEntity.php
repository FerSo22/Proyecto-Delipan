<?php
    ...
    class ReportReceiptsEntity {
        ...
        public function registerReport($totalAmount, $employee) {
            ...
            $query = "INSERT INTO reporte_boletas (fecha_registro, hora_registro, empleado, monto_total) "
                     ."VALUES (?, ?, ?, ?);";
        ...
        public function getCurrentDayReport() {
            ...
            $query = "SELECT id FROM reporte_boletas WHERE "
                     ."fecha_registro = ?;";
        ...
        public function getReportData($date) {
            ...
            $query = "SELECT id, hora_registro, empleado, monto_total FROM reporte_boletas WHERE "
                     ."fecha_registro = ?;";
        ...
        public function getReceiptsAmount() {
            ...
            $query = "SELECT monto_total FROM reporte_boletas WHERE "
                     ."fecha_registro = ?;";
        ...
        public function getReportAmount() {
            ...
            $query = "SELECT id, monto_total FROM reporte_boletas WHERE "
                     ."fecha_registro = ?;";
